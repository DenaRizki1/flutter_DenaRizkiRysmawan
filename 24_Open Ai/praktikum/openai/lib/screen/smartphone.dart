...
import 'package:openai/screen/result.dart';
import 'package:openai/services/recommendation.dart';
...
class _SmartphoneScreenState extends State<SmartphoneScreen> {
  ...
  void _getrecommendation() async {
    ...
    try {
      final result = await RecommendationService().getrecommendation(budget: _controller.text, camera: camvalue, storage: storagevalue);
