...
import 'package:openai/constant/open_ai.dart';
import 'package:openai/models/open_ai_model.dart';
import 'package:openai/utils/open_ai_utils.dart';
...
class RecommendationService {
  ...
  Future<GptData> getrecommendation({
    ...
    try {
      ...
      final response = await _dio.post(url, options: Options(headers: headers), data: data);
